...
class RecuringPaymentController extends Controller
{
    /**
     * @var ExpressCheckout
     */
    ...
    public function getIndex(Request $request)
    {
        ...
        return view('recuring', compact('response'));
    }
    ...
    {       
        ...
        try {        	
            $response = $this->provider->setExpressCheckout($cart, TRUE);					
    ...
    public function getExpressCheckoutSuccess(Request $request)
    {
        ...
        if (in_array(strtoupper($response['ACK']), ['SUCCESS', 'SUCCESSWITHWARNING'])) {
            ...
            if ($invoice->paid) {
                ...
                return view('payment_complete_recurring')->with(['code' => 'success', 'message' => "Order $invoice->id has been paid successfully!"]);
            } else {
                session()->put(['code' => 'danger', 'message' => "Error processing PayPal payment for Order $invoice->id!"]);
                return view('payment_complete_recurring')->with(['code' => 'danger', 'message' => "Error processing PayPal payment for Order $invoice->id!"]);
            }
    ...
    protected function getCheckoutData($recurring = false)
    {
        ...
        if ($recurring === true) {
            ...
            $data['return_url'] = url('/eccheckoutsuccess?mode=recurring');
            ...
            $data['return_url'] = url('/eccheckoutsuccess');
        }
